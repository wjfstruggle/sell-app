      ...
      <div class="container">
        <div class="checkout-addr">
          ...
          <div class="addr-list-wrap">
            <div class="addr-list">
              <ul>
                <li v-for="(item,index) in filterAddress" :key="index" v-bind:class="{'check':index==currentIndex}"
...
<script type="text/ecmascript-6">
  ...
  export default {
    ...
    created() {
      // const url = debug ? '/api/city' : 'https://github.com/artiely/Administrative-divisions-of-China/blob/master/dist/pcas.json'
      setTimeout(() => {
        this.getAddress()
      }, 30)
    },
    methods: {
      ...
      loadMore() {
        this.limitNum = this.city.length
      },
      setDefault(addressId) {
        this.city.forEach((address, index) => {
    ...
    computed: {
      filterAddress() {
        return this.city.slice(0, this.limitNum)
      }
    },
    watch: {},
    mounted() {
